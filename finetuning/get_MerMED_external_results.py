...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="./aggregated_external_results")
...
# Datasets to aggregate. Use "<train>-<test>" for a cross-dataset external
# evaluation (as produced by main_external.py), or a bare name for a single
# dataset. Edit to match the runs present under --result_dir.
compared_datasets = [
    "MIDOG25", "AMi-Br",
]
...
all_result_dir = f"all_path_ood_results_{train_sizes}"
# all_result_dir = f"all_path_external_results_{train_sizes}"
# all_result_dir = f"all_skin_external_results_{train_sizes}"
# all_result_dir = f"all_oct_external_results_{train_sizes}"
# all_result_dir = f"all_cpf_external_results_{train_sizes}"
# all_result_dir = f"all_cxr_external_results_{train_sizes}"
# all_result_dir = f"all_ct_external_results_{train_sizes}"
# all_result_dir = f"all_us_external_results_{train_sizes}"
