...
# from timm.optim.optim_factory import param_groups_weight_decay, param_groups_layer_decay
...
def my_get_params_groups(
    ...
    if isinstance(model_or_params, nn.Module):
        ...
        if layer_decay is not None:
            ...
            parameters = get_params_groups(model_or_params, weight_decay, no_weight_decay)
            weight_decay = 0.
        else:
